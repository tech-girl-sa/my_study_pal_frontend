...
export function useDeleteCourse(url, id, closeModal) {
  const navigate = useNavigate();
  const queryClient = useQueryClient();

  const { mutate, isPending, isError, error } = useMutation({
    mutationFn: () => deleteCourseApi(id), // your actual API call
    onSuccess: () => {
...
export function useDeleteSection(url, id, closeModal) {
  const navigate = useNavigate();
  const queryClient = useQueryClient();

  const { mutate, isPending, isError, error } = useMutation({
    mutationFn: () => deleteSectionApi(id), // your actual API call
    onSuccess: () => {
...
export function useDeleteSubject(url, id, closeModal) {
  const navigate = useNavigate();
  const queryClient = useQueryClient();

  const { mutate, isPending, isError, error } = useMutation({
    mutationFn: () => deleteSubjectApi(id), // your actual API call
    onSuccess: () => {
